...
from pp_analysis.network_backup import backup_network
from pp_analysis.network_restore import restore_network
from cp_analysis.static.specification import get_cluster_command
import logging
...
# python gateway.py -c 20 -d 15 -l -o network.json /dev/tty.usbserial-14410
