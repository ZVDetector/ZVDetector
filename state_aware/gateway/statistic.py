...
ATTRIBUTE_COUNT_DIR = os.path.join(os.path.dirname(os.getcwd()), "state_aware", "static/result/attribute")
PERMISSION_COUNT_DIR = os.path.join(os.path.dirname(os.getcwd()), "state_aware", "static/result/permission")
MESSAGE_COUNT_DIR = os.path.join(os.path.dirname(os.getcwd()), "state_aware", "static/result/format")
